	...
	: CDialogEx(IDD_TESTAPP_DIALOG, pParent)
{
	...
	eventSend.GetSendEvent1()->Add(&listenser1);
	eventSend.GetSendEvent2()->Add(&listenser2);
}
...
void CTestAppDlg::OnBnClickedOk()
{
	...
	eventSend.SendEvent1();
	eventSend.SendEvent2();


	TestEventSendClass sss;
	sss.GetSendEvent1()->Add(&listenser1);
	sss.SendEvent1();
	// TODO: 在此添加控件通知处理程序代码
	CDialogEx::OnOK();
}
